...
<body class="body-fix">
    ...
    <aside id="side-navbar" class="side-bar active">
        <ul class="side-navbar">
            ...
            <li class="side-navbar-li active"><a href="/dashboard/projetos.html" class="side-navbar-link">Projetos</a></li>
        ...
        <table class="tablecontent">
            ...
            <tbody>
                <tr class="table-row">
                    ...
                    <td class="table-data">Anderson Grandi Pires</td>
                    <td class="table-data">Matheus, Luan</td>
                    <td class="table-data"><img class="table-svg-icon" src="/images/pencil-file-svgrepo-com.svg" ></td>
                </tr>
                <tr class="table-row">
                    <td class="table-data">Oktoplus Gamming</td>
                    <td class="table-data">Gustavo Montes</td>
                    <td class="table-data">Luan, Samuel</td>
                    <td class="table-data"><img class="table-svg-icon" src="/images/pencil-file-svgrepo-com.svg" ></td>
                </tr>
                <tr class="table-row">
                    <td class="table-data">PET.COMP</td>
                    <td class="table-data">Luís Augusto</td>
                    <td class="table-data">Gabriela Dalpra</td>
                    <td class="table-data"><img class="table-svg-icon" src="/images/pencil-file-svgrepo-com.svg" ></td>
                </tr>
            </tbody>
        </table>
