...
<body class="body-fix">
    ...
    <div id="main-content" class="main-content active">
        <table class="tablecontent">
            ...
            <tbody>
                <tr class="table-row">
                    <td class="table-data">Lab. 6-115</td>
                    <td class="table-data">7</td>
                    <td class="table-data">Funcionando</td>
                    <td class="table-data"><a href="/dashboard/laboratorio/index.html"><img class="table-svg-icon" src="/images/paper-svgrepo-com.svg" ></a></td>
                </tr>
                <tr class="table-row">
                    <td class="table-data">Lab. 6-209</td>
                    <td class="table-data">0</td>
                    <td class="table-data">Em manutenção</td>
                    <td class="table-data"><a href="/dashboard/laboratorio/index.html"><img class="table-svg-icon" src="/images/paper-svgrepo-com.svg" ></a></td>
                </tr>
                <tr class="table-row">
                    <td class="table-data">Nietec</td>
                    <td class="table-data">0</td>
                    <td class="table-data">Desativado</td>
                    <td class="table-data"><a href="/dashboard/laboratorio/index.html"><img class="table-svg-icon" src="/images/paper-svgrepo-com.svg" ></a></td>
                </tr>
            </tbody>
        </table>
